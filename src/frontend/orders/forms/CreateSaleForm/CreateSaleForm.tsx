...
import CreateClientModal from "@/frontend/clients/modals/CreateClientModal/CreateClientModal";
    ...
    <div className="grid">
      <form className="flex flex-col gap-4 h-full" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col gap-2 h-full">
          ...
          <div className="flex flex-col bsale p-4 rounded-xl h-full bg-gray-50 gap-4">
